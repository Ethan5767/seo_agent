...
**As of 2026-09-08** · 7 packages, 66 modules, 5 workflows, 37 `wf-*` commands, 905 tests (904 pass; 1 pre-existing `test_scanner_server` failure from the in-flight per-tool-selection work, unrelated to `pipeline/seed`).
