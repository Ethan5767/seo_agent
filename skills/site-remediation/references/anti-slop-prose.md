<!-- Adopted 2026-07-30 from github.com/hardikpandya/stop-slop via boraoztunc/skills (MIT, v2.0.0, updated 2026-03-17). Verdict: ADOPT-TOOL.

WHY THIS EARNED A SLOT: our CLAUDE.md writing standards already ban em dashes, possessive contractions in headings, and sentence-case headings. This goes far deeper — false agency ("the complaint becomes a fix"), negative listing, throat-clearing openers, narrator-from-a-distance. Those are the AI tells a reader notices without being able to name, and they are exactly the differentiator the Design-and-Dev brief calls out.

SCOPE: applies to client-facing prose — page copy, ad copy, proposals, emails. Meridian house rules WIN on any conflict: Title Case headings stay (this doc does not address headings), and our em-dash ban is already stricter in deliverables.
-->
