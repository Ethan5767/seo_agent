...
function IconTerminal({ size = 18 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 600, color: "#4f46e5", background: "#eef2ff", border: "1px solid #c7d2fe", padding: "2px 8px", borderRadius: 12 }}>
            {activePoint.m} '26: {activePoint.v}{unit}
          </span>
        </div>
...
function resolveProjectData(
  ...
  const trafficAnalytics = {
    ...
    devices: { desktop: 36, mobile: 64 },
    monthlyTrend: [
      { m: "Oct", v: parseFloat((monthlyCalculatedVisits * 0.65 / 1000).toFixed(1)) },
      { m: "Nov", v: parseFloat((monthlyCalculatedVisits * 0.72 / 1000).toFixed(1)) },
      { m: "Dec", v: parseFloat((monthlyCalculatedVisits * 0.81 / 1000).toFixed(1)) },
      { m: "Jan", v: parseFloat((monthlyCalculatedVisits * 0.88 / 1000).toFixed(1)) },
      { m: "Feb", v: parseFloat((monthlyCalculatedVisits * 0.94 / 1000).toFixed(1)) },
      { m: "Mar", v: parseFloat((monthlyCalculatedVisits / 1000).toFixed(1)) },
    ],
  };
                ...
                <div style={{ display: "flex", gap: 8 }}>
                  {[
                    ...
                    <button
                      key={st.id}
                      type="button"
                      onClick={() => setAuditSubTab(st.id as any)}
                      style={{
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
                      {[
                        ...
                        },
                        {
                          ...
                          bg: "#eef2ff",
                          border: "#c7d2fe",
                          items: [`LCP ${projectMetrics.onPageSeoData.coreWebVitals.lcp.val} (${projectMetrics.onPageSeoData.coreWebVitals.lcp.status})`, `INP ${projectMetrics.onPageSeoData.coreWebVitals.inp.val} (${projectMetrics.onPageSeoData.coreWebVitals.inp.status})`, `CLS ${projectMetrics.onPageSeoData.coreWebVitals.cls.val} (${projectMetrics.onPageSeoData.coreWebVitals.cls.status})`, "Mobile asset caching"],
                        },
                        {
                          catKey: "site",
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              {/* Service 3: 100% Free API & Spend Shield */}
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <div>
                      <div style={{ fontSize: 14, fontWeight: 700, color: "#065f46" }}>
                        Hard Spend Freeze Active ($0.00 Mode)
                      </div>
                      <div style={{ fontSize: 12, color: "#047857", marginTop: 2 }}>
                        DataForSEO and third-party paid tool requests are blocked. Google Search Console & local engines run free of charge.
                      </div>
                    </div>
                  </div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <span style={{ fontSize: 14 }}>🛡️</span>
              <span><b>Spend Safety Latch Active:</b> External paid API testing is 100% frozen ($0.00 spend). Local offline engine and cached database checks only.</span>
            </div>
